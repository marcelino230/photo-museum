<div class="container">
	<div class="row mt-4">
		<div class="col">
			<h2 class="text-center"style=" color:white;">Update News</h2>
		</div>
	</div>
		...
		<div class="col">
			...
			<?= form_open_multipart(base_url('product/edit/' . $product['id'])) ?>
					...
					<div class="col-5 offset-2">
						<div class="form-group">
							...
							<select class="form-control" name="edition">
								<option value="news" <?php if($product['edition'] == "news"){ print ' selected'; }?>>News</option>
								<option value="event" <?php if($product['edition'] == "event"){ print ' selected'; }?>>Event</option>
							</select>
						</div>
					</div>
					<div class="col-5">
						<div class="form-group">
							...
							<input class="form-control" name="date" value="<?= $product['date'] ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input class="form-control" id="summernote2" name="address" rows="3" value="<?= $product['address'] ?>">
				...
				<div class="form-group row">
					...
					<div class="col">
						<?php if(!empty($product['image'])) : ?>
							<img src="<?= base_url('images/news/'. $product['image']) ?>" height="300" width="200">
						<?php else: ?>
							No Image
						<?php endif; ?>
						<br> <br>
